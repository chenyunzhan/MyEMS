...
<div id="wrapper">
  ...
  <div id="page" style="background-color:#F1F1F1; width:1050px"> <br />
    ...
    <div style="margin:0 auto; width:796px; height:800px; background-color:#FFFFFF">
      <div class="cWrap">
        <!-- //method QQ Number -->
        <br />
        <br />
        <div class="method clear" style="text-align:right"> <i class="iconMail" style="background:url(../images/regBg_001.png); margin-left:40px"></i>
          <div class="inner">
            ...
            <iframe style=" width:600px;" name="iframe_update" src="iframe_update.jsp" padding-righ="0px" padding-top="18px" onload="" frameborder="0" height="700" scrolling="no" width="660"></iframe>
            <!-- //cWrap -->
          </div>
        </div>
        <!-- //method Email -->
