...
<div id="imweb_main" class="main" >
    <form action="" method="post" name="from" onsubmit="return check()">
	...
	<input type="hidden" name="bool" value="bool" />
	 <div class="box box_3">
        ...
        <div class="box box_4">
            <div class="l">密码：</div>
            <div class="c">
                <input name="s_password" id="imweb_password" class="txt" maxlength="16" tabindex="4" type="password" value=<%=userInfoUpdata.getS_password() %> >
            </div>
        ...
        <div class="box box_11">
            <div class="l">&nbsp;</div>
            <div class="c">
                <button type="submit" tabindex="21" id="imweb_submit">确认提交</button><span id="imweb_waiting" class="waiting hidden">正在提交信息</span>
            </div>
            <div class="r"></div>
        </div>
