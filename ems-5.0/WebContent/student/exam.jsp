  ...
  <div id="header">
    <div id="menu">
      <ul>
        ...
        <li onmouseover="overBtn(this)" onmouseout="outBtn(this)"><a href="#">正式考试</a></li>
      </ul>
    </div>
    <!-- end #menu -->
    <div class="user">
  ...
  <br /><br /><br />
	<div class="exam_main" style="margin-left:auto; margin-right:auto;">
      ...
      <div class="exam_right">
		...
		<DIV class=kszuo>
<DIV class=dtkey><SPAN class=wdtm id=spwdt><%=pageModel.getTotalRecords()%>题未答</SPAN>
...
//                        } 
                        ...
                        $("#spwdt").html((<%=pageModel.getTotalRecords()%>-totalright-totalwrong)+"题未答");//未答题目
