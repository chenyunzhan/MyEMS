...
<div id="wrapper">
  ...
  <div id="header">
    <div id="menu">
      <ul>
        <li onmouseover="overBtn(this)" onmouseout="outBtn(this)"><a href="#" class="first">考生首页</a></li>
  ...
  <div id="page">
    <div id="page-bgtop">
      ...
      <div>
        <iu>
          <li>
            <h2 style="margin-top:15px">考试操作说明</h2>
          </li>
        </iu>
        <div align="center">
          <p align="center"> <span>根据考题大纲考试，严格按照正规考试比例出题。模拟正规考试系统界面，让学生提前适应</span>考试。 <span class="xg_czsm"><br />
              <span class="STYLE1">操作说明：</span></b>在远东模拟考试系统首页选择所在省市，点击进入后选择全真模拟功能。选择所做试题的类型后，点击进入。鼠标点击“开始答题”或键盘数字键上的“0”开始做题。答完所有试题后点击确认交卷可看到成绩及错题。</span>
            ...
            ·按下键盘中的“交卷”卷，可以看到交卷提示界面。按“确认交卷”提交试卷显示成绩，按“继续考试”键回到试题界面，可查看是否有漏题或修改考题答案。</span> <span><br />
            ·若学生想要答题时选定答案后自动翻页，可在“自动前进”的选项前勾选。若学生答题过程中想随时了解自己是否做对，可在“自动判错”选项前勾选。可也勾选“答题情况”了解自己答题的对错比例。“自动前进”与“自动判错”不可同时勾选。</span><span class="xg_zy"><em><br />
            </em><span class="STYLE3">注意：请先选择您要考试的课目后方可使用。</span></span> <span class="xg_djck"><a href="select_course.jsp"> <img src="../images/dj_07.gif" alt="" width="177" height="35" /></a></span> </p>
        </div>
      </div>
      <!-- end #sidebar -->
    </div>
