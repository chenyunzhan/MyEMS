	...
	<div class="exam_main" style="margin-left:auto; margin-right:auto;">
	  ...
	  <!-- 此处放置学生的头像 -->
	   ...
	   <img id="studentPhoto" border="1" height="147" width="120" style="border-color:#000000" src="../images/upload_images/<%=login.getId() %>.jpg" alt="" onerror="show_default_photo()"/>
        ...
        <div class="exam_username STYLE1">用 户 名<br />
        <span class="STYLE3"><%=login.getS_name() %></span></div>
		<div class="exam_userNo STYLE1">考 试 号<br />
	    ...
	    <div class="exam_oper_content">
	      <p>判断题<br />
          按“<span class="STYLE5">对/错</span>”键答题选择题<br />
          按“<span class="STYLE5">A/B/C/D</span>”键答题<br />
          按“<span class="STYLE5">上翻</span>”键查看上一题<br />
          按“<span class="STYLE5">下翻</span>”键进入下一题</p>
        </div>
	  </div>
      ...
      <div class="exam_right">
		...
		<!-- 
		<div id="Layer2" class="tiankonganswer">填空答案<br/>
		...
		<div id="Layer1"><img height="320" width="200" style="padding-top: 5px;" id="examimage" src="../images/defaultImage.gif" onerror="show_default()"/></div>
			...
			<div class="kszuo">
                    <ul class="qhcon">
                        ...
                        <li id="li_select" class="result"><span class="sysj">正确答案：</span><span class="zqda" style="font-size: 35px;
                            display: none" id="spzhengquedaan"></span><span class="daan">本次答案：</span>
                            <span class="answer" style="font-size: 35px;" id="spyhdaan"></span></li>
                        <li id="li_blank" class="result"><span class="sysj">正确答案：</span><span class="zqda" style="font-size: 35px;
                            display: none" id="spzhengquedaan"></span><span class="daan">本次答案：</span>
...
<script src="../js/jquery.min.js" type="text/javascript" language="JavaScript"></script>
        ...
        <script language="javascript" type="text/javascript">
                ...
                var fenshu = 0;//总分数
                var t;//时间
                var total = <%=pageModel.getTotalRecords()%> ;//题目总数
                    ...
                    {  if(!tijiao)
                        {
	                        ...
	                        $("#mydiv").css({"top":tbT,"left":tbL,"z-index":"9999","display":"block"})
	                        .html("<div class=\"jjts\"><b>考试结束</b><div class=\"end\"><i><img src=\"../images/icon_03.gif\" /></i><i><span class=\"ysjg\">已用时："+parseInt((45*60-miaozhong)/60)+":"+(45*60-miaozhong)%60+"</span><span>共得分数：<font class=\"hong\">"+totalright+"分</font></span></i></div><div class=\"end2\">已答题："+(totalright+totalwrong)+"  正确答题："+totalright+"  错误答题："+totalwrong+"  未答题："+(<%=paperManager.getTotalRecords()%>-totalright-totalwrong)+"</div><div class=\"tjan mz2\"><a href=\"javascript:fjieshu()\">结 束</a></div></div>"); 
	                        //记录考试成绩
