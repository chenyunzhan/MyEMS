...
<div id="wrapper">
  <div id="logo"></div>
	...
	<div id="header">
      <div id="menu">
        <ul>
          <li onmouseover="overBtn(this)" onmouseout="outBtn(this)"><a href="../index.jsp" class="first">返回学生登陆首页</a></li>
...
<!-- fwtable fwsrc="未命名" fwbase="admin_login1.jpg" fwstyle="Dreamweaver" fwdocid = "72864132" fwnested="0" -->
  ...
  <tr>
   ...
   <td rowspan="2" background="../images/admin_login1_r2_c2.jpg"><input name="aId" value="bll" style="width:125px; height:13px; " type="text" /></td>
  ...
  <tr>
   <td rowspan="2" background="../images/admin_login1_r5_c2.jpg"><input name="aPassword" value="111111" style="width:125px; height:13px;" type="password" /></td>
  ...
  <!-- InstanceEndEditable -->
	...
	<form name="form1" action="javascript:$('#hello').messagebox('登陆成功，马上为您跳转到后台管理首页！', 'index.jsp', 1, 2000);" method="get"> </form> <script language="javascript"> document.form1.submit() </script>
