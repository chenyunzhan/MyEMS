...
<div id="wrapper">
  <div id="logo"></div>
	...
	<div id="header">
      <div id="menu">
        <ul>
          ...
          <li onmouseover="overBtn(this)" onmouseout="outBtn(this)"><a href="#">查询成绩</a></li>
          <li onmouseover="overBtn(this)" onmouseout="outBtn(this)"><a href="login_out.jsp">退出登陆</a></li>
        </ul>
      </div>
	  <!-- end #menu -->
      <div id="search">
        <form target="clientDispAreaFrame" method="get" action="all_student_score.jsp">
          <fieldset>
	...
	<div id="backstage_main">
   		<script language=javascript >document.write("<IFRAME border=0 name=rl marginWidth=0 frameSpacing=0 marginHeight=0 src='student_score_maint.html' frameBorder=0 noResize width=1200 scrolling=no height=500 vspale='0'><\/IFRAME>")</script>
	</div>
  <!-- InstanceEndEditable -->
