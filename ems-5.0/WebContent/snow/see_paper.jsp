...
<div id="wrapper">
  ...
  <div id="header">
    <div id="menu">
      <ul>
        ...
        <li onmouseover="overBtn(this)" onmouseout="outBtn(this)"><a href="#">考题信息</a></li>
    ...
    <!-- end #menu -->
    <div id="search">
      <form target="clientDispAreaFrame" method="get" action="all_paper.jsp">
        <fieldset>
  ...
  <div id="backstage_main">
   <script language=javascript >document.write("<IFRAME border=0 name=rl marginWidth=0 frameSpacing=0 marginHeight=0 src='paper_maint.jsp' frameBorder=0 noResize width=1200 scrolling=no height=500 vspale='0'><\/IFRAME>")</script>
  </div>
  <!-- InstanceEndEditable -->
